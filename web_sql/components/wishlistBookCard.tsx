...
export default function WishlistBookCard({title, author, tags, rating, stock,description}: {title: string, author: string, tags: string[], rating: number, stock: number,description: string}){
                  ...
                  <CardFooter className='flex justify-between'>
                    ...
                    <AlertDialog>
                        <AlertDialogTrigger asChild>
                            <Button variant="default" className='font-bold p-5'>Remove</Button>
                        </AlertDialogTrigger>
                        <AlertDialogContent>
                        <AlertDialogHeader>
                                    <AlertDialogTitle>
                                ...
                                <AlertDialogDescription>
                                    You will no longer be able to access this book from your wishlist. Do you want to continue?
                                </AlertDialogDescription>
                                <AlertDialogFooter>
                                    <AlertDialogCancel>
                                    Cancel
                                    ...
                                    <Button
                                        ...
                                        toast({
                                            title: `${title}`,
                                            description: "Book has been removed from wishlist!",
                                            action: (
